...
const Login = () => {
    const { loading, authError, setAuthError, handleLogin } = useAuth()
        ...
        <main className="auth-page">
            <div className="auth-card">
                <div className="auth-header">
                    ...
                    <h1>Welcome Back</h1>
                    <p>Sign in to access your interview strategy reports</p>
                </div>
                ...
                <p className="auth-footer-text">Don't have an account? <Link to={"/register"}>Create Account</Link></p>
            </div>
        </main>
    )
}
